      ...
      <section className="max-w-4xl mx-auto px-6 py-12 border-t border-slate-50">
        ...
        <div className="grid grid-cols-1 gap-3">
          ...
          <div className="flex items-center justify-between p-4 border border-slate-100 rounded-xl hover:bg-slate-50/50 transition-colors">
            <div className="flex items-center gap-4">
              <CheckCircle2 size={16} className="text-emerald-500" />
              <div><h4 className="text-[13px] font-medium text-slate-800">Explainable ML model using XGBoost and SHAP</h4><p className="text-[11px] text-slate-400">Completed</p></div>
            </div>
          ...
          <div className="flex items-center justify-between p-4 border border-slate-100 rounded-xl hover:bg-slate-50/50 transition-colors">
            <div className="flex items-center gap-4">
              <CheckCircle2 size={16} className="text-emerald-500" />
              <div><h4 className="text-[13px] font-medium text-slate-800">ML Web App Integration</h4><p className="text-[11px] text-slate-400">Completed</p></div>
            </div>
            <span className="text-[11px] font-mono text-slate-400">March 2026</span>
          </div>
        </div>
